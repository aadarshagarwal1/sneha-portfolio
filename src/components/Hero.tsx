      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="block text-white">Sneha</span>
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            delivering 99%+ inventory accuracy and managing 500+ SKUs through advanced demand forecasting and ERP-driven controls.
          </p>

          {/* Contact Info */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-12 text-gray-300">
            <div className="flex items-center gap-2">
              <span>📧 Snehamuralikumar2810@gmail.com</span>
            </div>
            <div className="flex items-center gap-2">
              <span>📱 +353 89 972 2387</span>
            </div>
            <div className="flex items-center gap-2">
