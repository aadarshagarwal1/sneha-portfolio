      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <a href="mailto:Snehamuralikumar2810@gmail.com" className="text-gray-300 hover:text-blue-400 transition-colors">
              <Mail size={18} />
            </a>
            <a href="tel:+353899722387" className="text-gray-300 hover:text-blue-400 transition-colors">
              <Phone size={18} />
            </a>
            <a href="https://www.linkedin.com/in/sneha-murali-kumar" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-400 transition-colors">
              <Linkedin size={18} />
            </a>
          </div>
